...
$SCHRODINGER/phase_database ${SLURM_SUBMIT_DIR}/database/test10M.phdb splice test_phase_splice.list  -new -fmt int  -JOB test_phase_splice -HOST localhost:127  -WAIT
