...
split -l 10000000 -d -a 2  --additional-suffix=.smi Enamine_REAL_lead-like_randomized_00.smi  Enamine_REAL_file_1_part
# make sure that original DB files are not present in this directory otherwise, jobs will be created for original DB file as well
