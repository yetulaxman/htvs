...
$SCHRODINGER/ligprep -kp -retain  -lab -epik -W e,-ph,7.0,-pht,2.0,-ms,16 -i 2 -t 4 -s 4 -ismi "$INPUT_SMILES" -omae "$file".maegz -HOST localhost:10 -JOBNAME Legprep_test -LOCAL -WAIT
