...
```
The mentioned Singularity definition file (biobb_wf_md_setup.def) is available in the repository.
...
Use CSC's [lumi-container-wrapper](https://docs.csc.fi/computing/containers/tykky/) (aka, tykky wrapper) tool to install and make it usable as a module:
...
```
The above container wrapper command will install the software under the path : /projappl/project_465001676/yetukuri/biobb_md.
